...
|source|anchor name|
|------|----|
|mariadb.com|[cracklib_password_check_dictionary](https://mariadb.com/docs/server/reference/plugins/password-validation-plugins/cracklib-password-check-plugin#cracklib_password_check_dictionary)|
...
|source|anchor name|
|------|----|
|mariadb.com|[cracklib_password_check](https://mariadb.com/docs/server/reference/plugins/password-validation-plugins/cracklib-password-check-plugin#cracklib_password_check)|
...
|source|anchor name|
|------|----|
|mariadb.com|[spider_direct_aggregate](https://mariadb.com/docs/server/ha-and-performance/optimization-and-tuning/system-variables/spider-status-variables#spider_direct_aggregate)|
...
|source|anchor name|
|------|----|
|mariadb.com|[spider_direct_delete](https://mariadb.com/docs/server/ha-and-performance/optimization-and-tuning/system-variables/spider-status-variables#spider_direct_delete)|
...
|source|anchor name|
|------|----|
|mariadb.com|[spider_direct_order_limit](https://mariadb.com/docs/server/ha-and-performance/optimization-and-tuning/system-variables/spider-status-variables#spider_direct_order_limit)|
...
|source|anchor name|
|------|----|
|mariadb.com|[spider_direct_update](https://mariadb.com/docs/server/ha-and-performance/optimization-and-tuning/system-variables/spider-status-variables#spider_direct_update)|
...
|source|anchor name|
|------|----|
|mariadb.com|[spider_mon_table_cache_version](https://mariadb.com/docs/server/ha-and-performance/optimization-and-tuning/system-variables/spider-status-variables#spider_mon_table_cache_version)|
...
|source|anchor name|
|------|----|
|mariadb.com|[spider_mon_table_cache_version_req](https://mariadb.com/docs/server/ha-and-performance/optimization-and-tuning/system-variables/spider-status-variables#spider_mon_table_cache_version_req)|
...
|source|anchor name|
|------|----|
|mariadb.com|[spider_parallel_search](https://mariadb.com/docs/server/ha-and-performance/optimization-and-tuning/system-variables/spider-status-variables#spider_parallel_search)|
