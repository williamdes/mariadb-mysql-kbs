...
|source|anchor name|
|------|----|
|mariadb.com|[disks](https://mariadb.com/docs/server/reference/plugins/other-plugins/disks-plugin#disks)|
...
|source|anchor name|
|------|----|
|mariadb.com|[feedback_http_proxy](https://mariadb.com/docs/server/reference/plugins/other-plugins/feedback-plugin#feedback_http_proxy)|
...
|source|anchor name|
|------|----|
|mariadb.com|[feedback_send_retry_wait](https://mariadb.com/docs/server/reference/plugins/other-plugins/feedback-plugin#feedback_send_retry_wait)|
...
|source|anchor name|
|------|----|
|mariadb.com|[feedback_send_timeout](https://mariadb.com/docs/server/reference/plugins/other-plugins/feedback-plugin#feedback_send_timeout)|
...
|source|anchor name|
|------|----|
|mariadb.com|[feedback_server_uid](https://mariadb.com/docs/server/reference/plugins/other-plugins/feedback-plugin#feedback_server_uid)|
...
|source|anchor name|
|------|----|
|mariadb.com|[feedback_url](https://mariadb.com/docs/server/reference/plugins/other-plugins/feedback-plugin#feedback_url)|
...
|source|anchor name|
|------|----|
|mariadb.com|[feedback_user_info](https://mariadb.com/docs/server/reference/plugins/other-plugins/feedback-plugin#feedback_user_info)|
...
|source|anchor name|
|------|----|
|mariadb.com|[feedback](https://mariadb.com/docs/server/reference/plugins/other-plugins/feedback-plugin#feedback)|
...
|source|anchor name|
|------|----|
|mariadb.com|[file_key_management_encryption_algorithm](https://mariadb.com/docs/server/security/encryption/data-at-rest-encryption/key-management-and-encryption-plugins/file-key-management-encryption-plugin#file_key_management_encryption_algorithm)|

## file_key_management_digest
|name|value|
|----|-----|
|Name|`file_key_management_digest`|
|Command line|`--file-key-management-digest=value`|
|Type of variable|`enumeration`|
|Scope|`global`|
|Default value|`sha1`|
|Dynamic|`false`|
|Valid value(s)|`sha1`, `sha224`, `sha256`, `sha384`, `sha512`|

### Documentation(s)
|source|anchor name|
|------|----|
|mariadb.com|[file_key_management_digest](https://mariadb.com/docs/server/security/encryption/data-at-rest-encryption/key-management-and-encryption-plugins/file-key-management-encryption-plugin#file_key_management_digest)|
...
|source|anchor name|
|------|----|
|mariadb.com|[file_key_management_filekey](https://mariadb.com/docs/server/security/encryption/data-at-rest-encryption/key-management-and-encryption-plugins/file-key-management-encryption-plugin#file_key_management_filekey)|
...
|source|anchor name|
|------|----|
|mariadb.com|[file_key_management_filename](https://mariadb.com/docs/server/security/encryption/data-at-rest-encryption/key-management-and-encryption-plugins/file-key-management-encryption-plugin#file_key_management_filename)|

## file_key_management_use_pbkdf2
|name|value|
|----|-----|
|Name|`file_key_management_use_pbkdf2`|
|Command line|`--file-key-management-use-pbkdf2=number`|
|Type of variable|`integer`|
|Scope|`global`|
|Default value|`0`|
|Dynamic|`false`|
|Valid value(s)|`integers ≥ 0 (reasonable value: 600000 for sha256`, `less for sha512)`|

### Documentation(s)
|source|anchor name|
|------|----|
|mariadb.com|[file_key_management_use_pbkdf2](https://mariadb.com/docs/server/security/encryption/data-at-rest-encryption/key-management-and-encryption-plugins/file-key-management-encryption-plugin#file_key_management_use_pbkdf2)|
...
|source|anchor name|
|------|----|
|mariadb.com|[file_key_management](https://mariadb.com/docs/server/security/encryption/data-at-rest-encryption/key-management-and-encryption-plugins/file-key-management-encryption-plugin#file_key_management)|
...
|source|anchor name|
|------|----|
|mariadb.com|[query_response_time_flush](https://mariadb.com/docs/server/reference/plugins/other-plugins/query-response-time-plugin#query_response_time_flush)|
...
|source|anchor name|
|------|----|
|mariadb.com|[query_response_time_range_base](https://mariadb.com/docs/server/reference/plugins/other-plugins/query-response-time-plugin#query_response_time_range_base)|
...
|source|anchor name|
|------|----|
|mariadb.com|[query_response_time_exec_time_debug](https://mariadb.com/docs/server/reference/plugins/other-plugins/query-response-time-plugin#query_response_time_exec_time_debug)|
...
|source|anchor name|
|------|----|
|mariadb.com|[query_response_time_session_stats](https://mariadb.com/docs/server/reference/plugins/other-plugins/query-response-time-plugin#query_response_time_session_stats)|
...
|source|anchor name|
|------|----|
|mariadb.com|[query_response_time_stats](https://mariadb.com/docs/server/reference/plugins/other-plugins/query-response-time-plugin#query_response_time_stats)|
...
|source|anchor name|
|------|----|
|mariadb.com|[query_response_time](https://mariadb.com/docs/server/reference/plugins/other-plugins/query-response-time-plugin#query_response_time)|
...
|source|anchor name|
|------|----|
|mariadb.com|[query_response_time_audit](https://mariadb.com/docs/server/reference/plugins/other-plugins/query-response-time-plugin#query_response_time_audit)|
...
|source|anchor name|
|------|----|
|mariadb.com|[s3_access_key](https://mariadb.com/docs/server/server-usage/storage-engines/s3-storage-engine/s3-storage-engine-system-variables#s3_access_key)|
...
|source|anchor name|
|------|----|
|mariadb.com|[s3_block_size](https://mariadb.com/docs/server/server-usage/storage-engines/s3-storage-engine/s3-storage-engine-system-variables#s3_block_size)|
...
|source|anchor name|
|------|----|
|mariadb.com|[s3_bucket](https://mariadb.com/docs/server/server-usage/storage-engines/s3-storage-engine/s3-storage-engine-system-variables#s3_bucket)|
...
|source|anchor name|
|------|----|
|mariadb.com|[s3_debug](https://mariadb.com/docs/server/server-usage/storage-engines/s3-storage-engine/s3-storage-engine-system-variables#s3_debug)|
...
|source|anchor name|
|------|----|
|mariadb.com|[s3_host_name](https://mariadb.com/docs/server/server-usage/storage-engines/s3-storage-engine/s3-storage-engine-system-variables#s3_host_name)|
...
|source|anchor name|
|------|----|
|mariadb.com|[s3_no_content_type](https://mariadb.com/docs/server/server-usage/storage-engines/s3-storage-engine/s3-storage-engine-system-variables#s3_no_content_type)|
...
|source|anchor name|
|------|----|
|mariadb.com|[s3_pagecache_age_threshold](https://mariadb.com/docs/server/server-usage/storage-engines/s3-storage-engine/s3-storage-engine-system-variables#s3_pagecache_age_threshold)|
...
|source|anchor name|
|------|----|
|mariadb.com|[s3_pagecache_buffer_size](https://mariadb.com/docs/server/server-usage/storage-engines/s3-storage-engine/s3-storage-engine-system-variables#s3_pagecache_buffer_size)|
...
|source|anchor name|
|------|----|
|mariadb.com|[s3_pagecache_division_limit](https://mariadb.com/docs/server/server-usage/storage-engines/s3-storage-engine/s3-storage-engine-system-variables#s3_pagecache_division_limit)|
...
|source|anchor name|
|------|----|
|mariadb.com|[s3_pagecache_file_hash_size](https://mariadb.com/docs/server/server-usage/storage-engines/s3-storage-engine/s3-storage-engine-system-variables#s3_pagecache_file_hash_size)|
...
|source|anchor name|
|------|----|
|mariadb.com|[s3_port](https://mariadb.com/docs/server/server-usage/storage-engines/s3-storage-engine/s3-storage-engine-system-variables#s3_port)|
...
|source|anchor name|
|------|----|
|mariadb.com|[s3_protocol_version](https://mariadb.com/docs/server/server-usage/storage-engines/s3-storage-engine/s3-storage-engine-system-variables#s3_protocol_version)|
...
|Dynamic|`true`|
|Valid value(s)|`Default`, `Amazon`, `Huawei`|

### Documentation(s)
|source|anchor name|
|------|----|
|mariadb.com|[s3_provider](https://mariadb.com/docs/server/server-usage/storage-engines/s3-storage-engine/s3-storage-engine-system-variables#s3_provider)|
...
|source|anchor name|
|------|----|
|mariadb.com|[s3_region](https://mariadb.com/docs/server/server-usage/storage-engines/s3-storage-engine/s3-storage-engine-system-variables#s3_region)|
...
|source|anchor name|
|------|----|
|mariadb.com|[s3_replicate_alter_as_create_select](https://mariadb.com/docs/server/server-usage/storage-engines/s3-storage-engine/s3-storage-engine-system-variables#s3_replicate_alter_as_create_select)|
...
|source|anchor name|
|------|----|
|mariadb.com|[s3_secret_key](https://mariadb.com/docs/server/server-usage/storage-engines/s3-storage-engine/s3-storage-engine-system-variables#s3_secret_key)|
...
|source|anchor name|
|------|----|
|mariadb.com|[s3_slave_ignore_updates](https://mariadb.com/docs/server/server-usage/storage-engines/s3-storage-engine/s3-storage-engine-system-variables#s3_slave_ignore_updates)|
...
|source|anchor name|
|------|----|
|mariadb.com|[s3_ssl_no_verify](https://mariadb.com/docs/server/server-usage/storage-engines/s3-storage-engine/s3-storage-engine-system-variables#s3_ssl_no_verify)|
...
|source|anchor name|
|------|----|
|mariadb.com|[s3_use_http](https://mariadb.com/docs/server/server-usage/storage-engines/s3-storage-engine/s3-storage-engine-system-variables#s3_use_http)|
...
|source|anchor name|
|------|----|
|mariadb.com|[sql_error_log](https://mariadb.com/docs/server/ha-and-performance/optimization-and-tuning/system-variables/sql-error-log-system-variables-and-options#sql_error_log)|
...
|source|anchor name|
|------|----|
|mariadb.com|[sql_error_log_filename](https://mariadb.com/docs/server/ha-and-performance/optimization-and-tuning/system-variables/sql-error-log-system-variables-and-options#sql_error_log_filename)|
...
|source|anchor name|
|------|----|
|mariadb.com|[sql_error_log_rate](https://mariadb.com/docs/server/ha-and-performance/optimization-and-tuning/system-variables/sql-error-log-system-variables-and-options#sql_error_log_rate)|
...
|source|anchor name|
|------|----|
|mariadb.com|[sql_error_log_rotate](https://mariadb.com/docs/server/ha-and-performance/optimization-and-tuning/system-variables/sql-error-log-system-variables-and-options#sql_error_log_rotate)|
...
|source|anchor name|
|------|----|
|mariadb.com|[sql_error_log_rotations](https://mariadb.com/docs/server/ha-and-performance/optimization-and-tuning/system-variables/sql-error-log-system-variables-and-options#sql_error_log_rotations)|
...
|source|anchor name|
|------|----|
|mariadb.com|[sql_error_log_size_limit](https://mariadb.com/docs/server/ha-and-performance/optimization-and-tuning/system-variables/sql-error-log-system-variables-and-options#sql_error_log_size_limit)|
...
|source|anchor name|
|------|----|
|mariadb.com|[sql_error_log_warnings](https://mariadb.com/docs/server/ha-and-performance/optimization-and-tuning/system-variables/sql-error-log-system-variables-and-options#sql_error_log_warnings)|

## sql_error_log_with_db_and_thread_info
|name|value|
|----|-----|
|Name|`sql_error_log_with_db_and_thread_info`|
...
|source|anchor name|
|------|----|
|mariadb.com|[sql_error_log_with_db_and_thread_info](https://mariadb.com/docs/server/ha-and-performance/optimization-and-tuning/system-variables/sql-error-log-system-variables-and-options#sql_error_log_with_db_and_thread_info)|
