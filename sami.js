...
(function(root) {
    ...
    var bhIndex = null;
    var rootPath = '';
    var treeHtml = '        <ul>                <li data-name="namespace:Williamdes" class="opened">                    <div style="padding-left:0px" class="hd">                        <span class="glyphicon glyphicon-play"></span><a href="Williamdes.html">Williamdes</a>                    </div>                    <div class="bd">                                <ul>                <li data-name="namespace:Williamdes_MariaDBMySQLKBS" class="opened">                    <div style="padding-left:18px" class="hd">                        <span class="glyphicon glyphicon-play"></span><a href="Williamdes/MariaDBMySQLKBS.html">MariaDBMySQLKBS</a>                    </div>                    <div class="bd">                                <ul>                <li data-name="class:Williamdes_MariaDBMySQLKBS_Search" >                    <div style="padding-left:44px" class="hd leaf">                        <a href="Williamdes/MariaDBMySQLKBS/Search.html">Search</a>                    </div>                </li>                </ul></div>                </li>                </ul></div>                </li>                </ul>';
